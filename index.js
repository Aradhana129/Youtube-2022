...
async function display(){
    ...
    let res = await fetch(`https:www.googleapis.com/youtube/v3/search?part=snippet&key=AIzaSyDsV6RK0dytl2VMbzzfwx8F-uM69r9qcLs&type=video&q&maxResults=15`);
...
//search for videos
let res = await fetch('https://youtube.googleapis.com/youtube/v3/search?q=newtonschool%20video&key=AIzaSyDW2AJVOCDsrVUABKqcORlC-3sRCMN0IOY&maxResults=30');
let data = await res.json();
